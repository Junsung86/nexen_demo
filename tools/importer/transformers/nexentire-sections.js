...
/**
 * Transformer: nexentire section breaks + section metadata.
 * Template "news" has 5 sections; inserts <hr> before each non-first section
 * and a Section Metadata block for each section that has a style.
